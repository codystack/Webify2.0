                           ...
                           <div class="row">
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-12 order-1 order-lg-0">
                                 <div class="tp-project-3-content text-center">
                                    ...
                                    <h4 class="tp-project-3-title-sm"><a href="portfolio-details-1.html">Pellente dapibus</a></h4>
                        ...
                        <div class="tp-project-3-wrap">
                           <div class="row">
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-12 order-1 order-lg-0">
                                 <div class="tp-project-3-content text-center">
                                    <span class="tp-project-3-meta">DEC 2024 . Creative </span>
                                    <h4 class="tp-project-3-title-sm"><a href="portfolio-details-1.html">Chania tourism</a></h4>
                                    <a class="tp-btn-project-sm" href="portfolio-details-1.html">See Project</a>
                                 </div>
                        ...
                        <div class="tp-project-3-wrap">
                           <div class="row">
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-12 order-1 order-lg-0">
                                 <div class="tp-project-3-content text-center">
                                    <span class="tp-project-3-meta">DEC 2024 . Creative </span>
                                    <h4 class="tp-project-3-title-sm"><a href="portfolio-details-1.html">Fashion sentence</a></h4>
                                    <a class="tp-btn-project-sm" href="portfolio-details-1.html">See Project</a>
                                 </div>
                        ...
                        <div class="tp-project-3-wrap">
                           <div class="row">
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-12 order-1 order-lg-0">
                                 <div class="tp-project-3-content text-center">
                                    <span class="tp-project-3-meta">DEC 2024 . Creative </span>
                                    <h4 class="tp-project-3-title-sm"><a href="portfolio-details-2.html">Fashion sentence</a></h4>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-xl-9">
                        <div class="tp-service-3-title-box mb-60 p-relative">
                           ...
                           <h4 class="tp-section-title-90 tp_text_invert tp_fade_bottom">Creative <br> development studio</h4>
                        </div>
                     </div>
                  </div>
                  <div class="tp-service-3-wrap tp_fade_bottom">
                     <div class="row align-items-start">
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-service-3-title-box">
                              <h4 class="tp-service-3-title"><a href="service.html">Product design</a></h4>
                           </div>
                        </div>
                        <div class="col-xl-7 col-lg-7">
                           <div class="tp-service-3-content">
                              <p>
                                 Once we have an idea of your needs, a research and design process
                                 begins to gain deep knowledge about the business, users <br>
                                 and world context.
                              </p>
                              <div class="tp-service-3-category">
                                 <span>Research</span>
                                 <span>Ui/ UX</span>
                        ...
                        <div class="col-xl-2 col-lg-2">
                           <div class="tp-service-3-btn-box text-start text-md-end">
                              <a class="tp-btn-zikzak-sm p-relative" href="service.html">
                                 <span class="zikzak-content">
                                    See <br> Details
                                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 <span>
                                    <svg class="svg-bg" xmlns="http://www.w3.org/2000/svg" width="130" height="130" viewBox="0 0 130 130" fill="none">
                  ...
                  <div class="tp-service-3-wrap tp_fade_bottom">
                     <div class="row align-items-start">
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-service-3-title-box">
                              <h4 class="tp-service-3-title"><a href="service.html">Web/Mobile</a></h4>
                           </div>
                        </div>
                        <div class="col-xl-7 col-lg-7">
                           <div class="tp-service-3-content">
                  ...
                  <div class="tp-service-3-wrap tp_fade_bottom">
                     <div class="row align-items-start">
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-service-3-title-box">
                              <h4 class="tp-service-3-title"><a href="service.html">Consulting</a></h4>
                           </div>
                        </div>
                        <div class="col-xl-7 col-lg-7">
                           <div class="tp-service-3-content">

   ...
   <div id="smooth-wrapper">
      <div id="smooth-content">
         ...
         <main>
            ...
            <div class="ab-2-hero-area ab-2-hero-ptb  p-relative">
               <div class="ab-2-hero-social-wrap d-none d-lg-block">
                  <div class="ab-2-hero-social">
                     <a href="https://x.com/Webifyng" target="_blank">
                        <span>
                     ...
                     <a href="https://www.instagram.com/webifyng/" target="_blank">
                        <span>
                     ...
                     <a href="https://web.facebook.com/webifyng" target="_blank">
                        <span>
                     ...
                     <div class="row">
                        <div class="col-xl-7">
                           <div class="ab-2-hero-title-box p-relative">
                              <h4 class="ab-2-hero-title tp-char-animation" data-stagger="0.05" data-on-scroll="0" data-delay="0.6">A tailored design &</h4>
                              <div class="ab-2-hero-shape-1">
                                 <img src="assets/img/inner-about/hero/hero-2-shape-1.jpg.png" alt="">
                              </div>
                              <div class="ab-2-hero-shape-2">
                                 <img class="tp-zoom-in-out" src="assets/img/inner-about/hero/hero-2-shape-2.jpg.png" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-xl-10 offset-xl-2">
                           <div class="ab-2-hero-thumb-wrap p-relative">
                              <img src="assets/img/pexels-darlene-alderson-7971550.jpg" width="500px" alt="" data-speed="0.9">
                              <h4 class="ab-2-hero-title tp-char-animation" data-stagger="0.05" data-on-scroll="0" data-delay="0.6">an <br>expert<br> team.</h4>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="ab-about-content p-relative tp_fade_bottom">
                           ...
                           <p class="tp-dropcap">
                              We bring brands to life through creative solutions that are both effective and innovative – setting visual, verbal, and experiential standards that drive impactful experiences.
                           </p>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           <div class="col-xl-5 col-lg-5 col-md-4 mb-40">
                              <div class="ab-about-category-title-box tp_fade_bottom ab-2-about-title-style p-relative">
                                 <h4 class="ab-about-category-title">Something about us<br><span>What we do</span></h4>
                              ...
                              <div class="row">
                                 <div class="col-xl-6 col-lg-6 col-md-6 mb-40 tp_fade_bottom">
                                    <div class="ab-about-category-list category-space-1">
                                       <span class="ab-about-category-title mb-30">Web & Product Development</span>
                                       <ul>
                                          <li>UI/UX Design</li>
                                 ...
                                 <div class="col-xl-6 col-lg-6 col-md-6 mb-40 tp_fade_bottom">
                                    <div class="ab-about-category-list category-space-2">
                                       <span class="ab-about-category-title mb-30">Brand Identity & Design</span>
                                       <ul>
            ...
            <div class="ab-2-work-area pb-115">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-6 col-lg-5">
                        <div class="ab-2-work-title-box p-relative">
                           <h4 class="ab-2-work-title tp_title_anim">From Dream <br> to Reality</h4>
                           <span class="ab-2-work-subtitle tp_title_anim">About Us</span>
                           <img class="ab-2-work-shape d-none d-lg-block" src="assets/img/inner-about/about/shape-1.png" alt="">
                        </div>
                     </div>
                     <div class="col-xl-6 col-lg-7">
                        <div class="tp_fade_bottom">
